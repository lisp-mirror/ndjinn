...
(pyx:define-texture skybox (:cube-map)
  (:source (:x+ "data/skybox/sky-right.png"
            :x- "data/skybox/sky-left.png"
            :y+ "data/skybox/sky-bottom.png"
            :y- "data/skybox/sky-top.png"
            :z+ "data/skybox/sky-front.png"
            :z- "data/skybox/sky-back.png")))

(pyx:define-material skybox ()
  (:shader shader:skybox
   :uniforms (:sampler 'skybox)
