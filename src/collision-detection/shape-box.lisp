...
(defstruct (collider-shape/box
            (:constructor %make-collider-shape/box)
            (:conc-name box-)
...
(defun make-collider-shape/box (&rest args)
  (let ((shape (apply #'%make-collider-shape/box args)))
    (setf (box-update-func shape) #'update-collider-shape/box)
    shape))
...
(defun update-collider-shape/box (shape)
  (declare (optimize speed))
  (let* ((entity (collider-shape-entity shape))
         (center (collider-shape-center shape))
