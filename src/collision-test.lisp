...
(defmethod collide-p ((shape1 collision-shape/sphere)
...
(defun %collide-p/sphere-box (sphere box)
  ...
  (let* ((sphere-entity (collision-shape-entity sphere))
         (sphere-center (transform-point sphere-entity
                                         (collision-shape-center sphere)))
...
(defmethod collide-p ((shape1 collision-shape/sphere)
                      (shape2 collision-shape/box))
  (%collide-p/sphere-box shape1 shape2))

(defmethod collide-p ((shape1 collision-shape/box)
                      (shape2 collision-shape/sphere))
  (%collide-p/sphere-box shape2 shape1))

(defmethod collide-p ((shape1 collision-shape/box) (shape2 collision-shape/box))
