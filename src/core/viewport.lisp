...
(defun configure-viewport (viewport)
  (let ((spec (spec viewport))
    ...
    (setf (x viewport) (u:lerp (x spec) 0 width)
          (y viewport) (u:lerp (y spec) 0 height)
          (width viewport) (u:lerp (width spec) 0 width)
          (height viewport) (u:lerp (height spec) 0 height)))
