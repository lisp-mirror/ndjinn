...
(defun transform-node/quaternion (state delta frame-time)
  ...
  (math:velocity->rotation! (incremental-delta state)
                            (incremental state)
                            delta)
